...
v.na_count <- sapply(d.combined_weather_data, function(x) sum(is.na(x)))

# Sum of total NA values
sum(v.na_count)

# Save the combined dataframe to a new CSV file
write_csv(d.combined_weather_data, "data/combined_weather_data.csv")
...
write_xlsx(d.merged_data, "data/merged_data.xlsx")
